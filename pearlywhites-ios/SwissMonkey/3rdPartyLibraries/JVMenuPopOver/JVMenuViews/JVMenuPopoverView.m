...
- (UITableView *)tableView
{
    if(!_tableView)
    {
        _tableView = [[UITableView alloc] initWithFrame:CGRectMake(0, 112, self.frame.size.width, self.frame.size.height - 112) style:UITableViewStylePlain];
...
- (UIButton *)closeBtn
{
    if(!_closeBtn)
    {
        ...
        _closeBtn.frame = CGRectMake(24, 30, self.menuItems.menuCloseButtonImage.size.width, self.menuItems.menuCloseButtonImage.size.height);
...
//        _shadowView.alpha = 0.0;
        _shadowView.backgroundColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"graydiant"]];
    }
...
- (UIImageView *)backgroundView
{
    if (!_backgroundView)
    {
        ...
        _backgroundView.image = [UIImage imageNamed:@"graydiant"];
        ...
        [NSLayoutConstraint constraintsWithVisualFormat:@"H:|-(0)-[_backgroundView]-(0)-|"
                                                options: NSLayoutFormatAlignAllCenterX
                                                metrics:nil
                                                  views:@{@"_backgroundView" : _backgroundView}];
        NSArray *vertConstraints =
        [NSLayoutConstraint constraintsWithVisualFormat:@"V:|-(0)-[_backgroundView]-(0)-|"
...
- (UIVisualEffectView *)blurEffectView
{
    if(!_blurEffectView)
    {
        ...
        _blurEffectView.backgroundColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"graydiant"]];
    }
...
-(UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    {
        [cell setLayoutMargins:UIEdgeInsetsMake(0, 59, 0, 0)];
    }
    ...
    cell.textLabel.font = [UIFont appLatoLightFont18];
...
- (void)showMenuWithController:(UIViewController *)viewController
{
    ...
    [[ReusedMethods sharedObject] setMenuOpened:YES];
...
- (void)closeMenu
{
    ...
    [[ReusedMethods sharedObject] setMenuOpened:NO];
