package com.rapidbizapps.swissmonkey.resideMenu;
...
public class ResideMenu extends FrameLayout {
    ...
    private boolean mUseAnchor = true;
    private float mAnchorWidth = 200.f;
    ...
    public void openMenu(int direction) {
        Log.e("openMenu","--"+scrollViewMenu);
        setScaleDirection(direction);
        if(scrollViewMenu!=null) {
            isOpened = true;
            AnimatorSet scaleDown_activity = buildScaleDownAndAnchorAnimation(viewActivity, mScaleValue, mScaleValue, mUseAnchor, mAnchorWidth);
            AnimatorSet scaleDown_shadow = buildScaleDownAndAnchorAnimation(imageViewShadow,
                    mScaleValue + shadowAdjustScaleX, mScaleValue + shadowAdjustScaleY, mUseAnchor, mAnchorWidth);
    ...
    public void closeMenu() {
        ...
        Log.e("closeMenu","--"+scrollViewMenu);
        if(scrollViewMenu!=null) {
            isOpened = false;
            AnimatorSet scaleUp_activity = buildScaleUpAnimation(viewActivity, 1.0f, 1.0f, mUseAnchor);
            AnimatorSet scaleUp_shadow = buildScaleUpAnimation(imageViewShadow, 1.0f, 1.0f, mUseAnchor);
     ...
     * @return
     */
    private AnimatorSet buildScaleDownAndAnchorAnimation(View target, float targetScaleX, float targetScaleY, boolean bUseAnchor, float anchorWidth) {
        ...
        if (bUseAnchor) {
            scaleDown.playTogether(ObjectAnimator.ofFloat(target, "X", getScreenWidth() - anchorWidth));
        }
     ...
     * @return
     */
    private AnimatorSet buildScaleUpAnimation(View target, float targetScaleX, float targetScaleY, boolean bUseAnchor) {
        ...
        if (bUseAnchor) {
            scaleUp.playTogether(ObjectAnimator.ofFloat(target, "X", 0));
        }
...
// TODO: un-comment the code to enable swipe functionality if needed.
