...
import com.rba.R;
import com.rba.dialog.internal.MDButton;
import com.rba.dialog.internal.MDRootLayout;
import com.rba.dialog.internal.MDTintHelper;
import com.rba.dialog.util.DialogUtils;
import com.rba.dialog.util.TypefaceHelper;
...
public class MaterialDialog extends DialogBase implements
    ...
    public static class Builder {
        ...
        /**
         * Sets the gravity used for the text in stacked action buttons. By default, it's #{@link com.rba.dialog.GravityEnum#END}.
         *
     ...
     * Use {@link #setActionButton(com.rba.dialog.DialogAction, int)} to change text, since the view returned here is not
